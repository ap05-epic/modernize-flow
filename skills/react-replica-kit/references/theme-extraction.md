...
legacy CSS source once**, app-wide, and the builder styles from those tokens.
...
- `theme.css` — `:root { --color-01: #006286; --font-1: 'Frutiger 45 Light',sans-serif; --fs-13: 13px; … }`,
  top values as CSS variables, ordered by frequency.
...
extraction and keeps the analyzer dependency-free; reach for css-tree only if the regex misses something.
